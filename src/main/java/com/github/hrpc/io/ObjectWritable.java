...
public class ObjectWritable implements Writable {
    ...
    public static void writeObject(DataOutput out, Object instance,
        ...
        writeObject(out, instance, declaredClass, false);
    }
     ...
     */
    public static void writeObject(DataOutput out, Object instance,
                                   Class declaredClass, boolean allowCompactArrays)
            throws IOException {
        ...
        if (declaredClass.isArray()) {     // non-primitive or non-compact array
            ...
            for (int i = 0; i < length; i++) {
                writeObject(out, Array.get(instance, i),
                        declaredClass.getComponentType(), allowCompactArrays);
            }
