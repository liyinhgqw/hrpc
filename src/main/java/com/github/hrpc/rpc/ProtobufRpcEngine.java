...
import com.github.hrpc.io.DataOutputOutputStream;
import com.github.hrpc.io.Writable;
import com.github.hrpc.util.Option;
import com.github.hrpc.util.ProtoUtil;
...
import com.github.hrpc.rpc.protobuf.ProtobufRpcEngineProtos.RequestHeaderProto;
...
public class ProtobufRpcEngine implements RpcEngine {
    ...
    static { // Register the rpcRequest deserializer for WritableRpcEngine
        com.github.hrpc.rpc.Server.registerProtocolEngine(
    ...
    public RPC.Server getServer(Class<?> protocol, Object protocolImpl,
                                ...
                                int queueSizePerHandler, boolean verbose, Option conf,
    ...
    public static class Server extends RPC.Server {
        ...
        public Server(Class<?> protocolClass, Object protocolImpl,
                      Option conf, String bindAddress, int port, int numHandlers,
