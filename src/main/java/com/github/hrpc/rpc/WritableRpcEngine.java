...
import com.github.hrpc.io.ObjectWritable;
...
public class WritableRpcEngine implements RpcEngine {
    ...
    private static synchronized void initialize() {
        com.github.hrpc.rpc.Server.registerProtocolEngine(RPC.RpcKind.RPC_WRITABLE,
    ...
    private static class Invoker implements RpcInvocationHandler {
        ...
        public Invoker(Class<?> protocol,
                       ...
                       Option conf, SocketFactory factory,
    ...
    public static class Server extends RPC.Server {
         ...
         */
        @Deprecated
        public Server(Object instance, Option conf, String bindAddress,
        ...
        public Server(Class<?> protocolClass, Object protocolImpl,
                      Option conf, String bindAddress, int port)
                throws IOException {
         ...
         */
        @Deprecated
        public Server(Object protocolImpl, Option conf, String bindAddress,
        ...
        public Server(Class<?> protocolClass, Object protocolImpl,
                      Option conf, String bindAddress,  int port,
                      int numHandlers, int numReaders, int queueSizePerHandler,
                      boolean verbose, String portRangeConfig)
                throws IOException {
        ...
        static class WritableRpcInvoker implements RpcInvoker {
            ...
            @Override
            public Writable call(RPC.Server server,
