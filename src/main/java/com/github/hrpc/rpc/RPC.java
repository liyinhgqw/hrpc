...
import com.github.hrpc.rpc.protobuf.ProtocolInfoProtos.ProtocolInfoService;
import com.github.hrpc.util.Option;
import com.github.hrpc.util.ReflectionUtils;
import com.github.hrpc.util.Time;
...
public class RPC {
     ...
     */
    public static void setProtocolEngine(Option conf,
    ...
    static synchronized RpcEngine getProtocolEngine(Class<?> protocol,
        ...
        if (engine == null) {
            ...
            engine = (RpcEngine) ReflectionUtils.newInstance(impl);
    ...
    public static <T> T waitForProxy(Class<T> protocol, long clientVersion,
                                     InetSocketAddress addr, Option conf,
        ...
        while (true) {
            try {
                return getProtocolProxy(protocol, clientVersion, addr,
                        conf, NetUtils.getDefaultSocketFactory(), rpcTimeout,
    ...
    public static <T> ProtocolProxy<T> getProtocolProxy(Class<T> protocol,
                                                        ...
                                                        SocketFactory factory) throws IOException {
        return getProtocolProxy(
                protocol, clientVersion, addr, conf, factory, 0, null);
    }
    ...
    public static <T> ProtocolProxy<T> getProtocolProxy(Class<T> protocol,
        ...
        return getProtocolEngine(protocol, conf).getProxy(protocol, clientVersion,
                addr, conf, factory, rpcTimeout, connectionRetryPolicy);
    }
     ...
     * @throws IllegalArgumentException if the proxy does not implement {@link Closeable} interface or
    ...
    public static class Builder {
        ...
        private final Option conf;
        private String portRangeConfig = null;

        public Builder(Option conf) {
            this.conf = conf;
        }
        ...
        public Server build() throws IOException, IllegalArgumentException {
            ...
            return getProtocolEngine(this.protocol, this.conf).getServer(
                    ...
                    this.verbose, this.conf, this.portRangeConfig);
        }
    }
     ...
     * An RPC Server.
     */
    public abstract static class Server extends com.github.hrpc.rpc.Server {
        boolean verbose;
        ...
        private void initProtocolMetaInfo(Option conf) {
